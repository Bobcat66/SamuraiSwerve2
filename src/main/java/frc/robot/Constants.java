    ...
    public static class DriveConstants {
        ...
        public static class ModuleConstants {
            ...
            public static enum ModuleConfig {
                FrontLeft(-1,-1,-1,new Rotation2d(),"FrontLeftModule"),
                FrontRight(-1,-1,-1,new Rotation2d(),"FrontRightModule"),
                RearLeft(-1,-1,-1,new Rotation2d(),"RearLeftModule"),
                RearRight(-1,-1,-1,new Rotation2d(),"RearRightModule");

                public final int driveMotorPort;
                public final int turnMotorPort;
